...
@section('content')
    ...
    <form action="/article/{{$data['article']->id}}" method="post">
        <div class="form-group col-md-4">
            ...
            <input class="form-control" id="exampleInputEmail1" name="title" type="text" aria-describedby="emailHelp" value="{{$data['article']->title}}" placeholder="">
        </div>
        <div class="form-group col-md-4">
            ...
            <select name="cate_id" id="" class="form-control">
                ...
                <option @if($v->id == $data['article']->cate_id) selected @endif value="{{$v->id}}">{{$v->name}}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-6">
            ...
            <textarea name="intro" class="form-control">{{$data['article']->intro}}</textarea>
        </div>

        <div class="form-group col-md-12">
            <label for="exampleInputPassword1">内容</label>
            <div id="markdown" name="markdown" value="{{$data['article']->markdown}}"></div>
        </div>
        ...
        $(function(){
            ...
            var testEditor = editormd("markdown", {
                ...
                onload : function() {
                    ...
                    //this.resize("100%", 640);
                    // this.setMarkdown()
                    this.setMarkdown(document.getElementById(this.id).getAttribute('value'));
