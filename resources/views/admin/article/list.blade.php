                ...
                <table class="table table-bordered"  data-b-info="false"   data-ordering="" id="dataTable" width="100%" cellspacing="0" data-order="[]">
                    ...
                    @foreach($data['articles'] as $k=>$v)
                        <tr>
                            ...
                            <td><a href="{{url('/article/'.$v->id.'/edit')}}" class="btn btn-info btn-sm">修改</a>&nbsp;&nbsp;<a href="{{url('/article/'.$v->id)}}" class="btn btn-danger btn-sm del" onclick="return del(this)">删除</a></td>
                        </tr>
                    @endforeach
