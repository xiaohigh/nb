...
@section('content')
    ...
    <form action="/lesson" method="post" enctype="multipart/form-data">
        <div class="form-group col-md-4">
            ...
            <input class="form-control" disabled value="{{$course->title}}">
            <input class="form-control" id="exampleInputEmail1" value="{{$course->id}}" name="course_id" type="hidden" aria-describedby="emailHelp" placeholder="">
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input class="form-control" id="exampleInputEmail1" value="{{old('pos')}}" name="pos" type="text" aria-describedby="emailHelp" placeholder="">
        </div>

        <div class="form-group col-md-4">
            <label for="exampleInputPassword1">视频</label>
            <input class="form-control" name="video" value="{{old('video')}}" id="exampleInputPassword1" type="file">
        </div>
